...
// Tu código acá:
var nom = document.querySelector('#createdBy');
nom.innerHTML = nom.innerHTML + 'Bautista'
...
//  3) Setear el valor del input toDoInput como un string vacio ("") (Esto se realiza para que en la vista
